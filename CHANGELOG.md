...
- **BREAKING** No trigger fires in the middle of a word. `blabla@` and `any.pattern@` stay ordinary text, where the previous rule fired on any trigger ending at the caret.
